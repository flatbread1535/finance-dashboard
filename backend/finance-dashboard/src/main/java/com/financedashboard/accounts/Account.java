...
/**
 * Spring Data JPA entity representing a user's account in the 
...
public class Account {
   ...
   * @param hashPassword the hashed password used for account authentication
   */
  public Account(
      Long accountId,
      Role role,
